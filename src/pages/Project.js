...
const projects = [
  {
    ...
    skills: 'Next.js, TypeScript, Git, Vercel',
    description: '빈폴 웹사이트: 원 페이지 스크롤 및 렌더링',
  ...
  },
  {
    ...
    title: 'KEKEKE',
    type: '팀 프로젝트 (5명)',
    skills: 'React, HTML/CSS, JavaScript, Node.js, Flask, MySQL, Firebase, Python, KakaoMap Api, Socket API, Konva API, Git, Notion, Figma',
  ...
  },
  {
    ...
    title: 'MistyBot',
    type: '팀 프로젝트 (4명)',
    skills: 'Android Studio, Kotlin, Ubuntu, Raspberry Pi, Arduino, Python, Firebase, Git, Notion, Figma',
    description: '이동형 자동 가습기 및 어플리케이션',
  ...
  },
  {
    ...
    title: 'PUPPIET',
    type: '팀 프로젝트 (5명)',
    skills: 'React, HTML/CSS, JavaScript, Firebase, Git',
    description: '반려견 다이어트를 위한 웹 애플리케이션\n견종과 BMI 수치에 따른 사료 추천 및 일일 사료량 계산',
  ...
  },
  {
    ...
    title: 'Portfolio',
    type: '개인 프로젝트',
    skills: 'React, HTML/CSS, javascript, Git, Netlify',
